---
schemaVersion: 1
draftId: "019fbb5b-05f5-71d8-be1b-9f49d0988b03"
slug: "active-recall-why-retrieval-beats-re-reading"
locale: "en"
pageType: "concept"
...
faq:
  - question: "What is the difference between active recall and passive review?"
    answer: "Passive review means re-reading notes, watching explanations, or reviewing highlights. Active recall means closing the source and reconstructing what you know from memory without any prompts. The difference is the cognitive operation: recognition versus retrieval. Research consistently shows that retrieval events produce stronger, more durable memory than recognition-based review, even when total study time is the same."
  - question: "What is cue-dependent forgetting, and why does it matter for flashcard users?"
    answer: "Cue-dependent forgetting occurs when a memory becomes tightly linked to the specific context in which it was encoded, making it hard to access when that context is absent. If you study with flashcards, the question itself becomes the retrieval cue. You may answer perfectly during a flashcard session but draw a blank on an exam because the original cue is gone. The fix is to include free-recall practice, where you reconstruct knowledge without any specific prompt, alongside cued flashcard review."
  - question: "How does spaced repetition relate to active recall?"
    answer: "Spaced repetition is a scheduling system that determines when retrieval practice should occur. It resurfaces material at increasing intervals, so you review something soon after initial learning, then at growing gaps as retention strengthens. This timing targets the edge of forgetting, where retrieval requires effort and produces the strongest memory consolidation. Active recall is the retrieval event that happens during each scheduled session; spaced repetition is the mechanism that times those events for maximum effect."
  - question: "What is the sneaky plagiarism technique?"
    answer: "Sneaky plagiarism is a closed-book reorganization method. After studying a topic, close all notes and rewrite what you know using a different framework or structure than the original source used. Because the source is not visible, you cannot copy phrasing or sequence. You must reconstruct the logic from memory and express it through your own organizational choices. This produces stronger encoding than open-book summarization because it requires free retrieval rather than recognition-aided transcription."
  - question: "Why does simplifying hard material sometimes backfire?"
    answer: "Simplification reduces cognitive load, which can feel helpful in the moment. The problem is that the effort of making sense of difficult material is itself part of the encoding process. Robert Bjork's research on desirable difficulty shows that conditions requiring more work during study, such as retrieving partially-forgotten information or working through unprocessed source text, produce stronger long-term retention than conditions designed to minimize difficulty. When simplified summaries remove that friction, they also remove the cognitive work that makes knowledge stick."
references:
...
sources:
  - id: "019fb0f6-f7ae-74bb-9656-30da252d3085"
    type: "youtube_video"
    title: "Give me 28 Minutes, And I’ll Make You Learn Anything Dangerously Fast"
    url: "https://www.youtube.com/watch?v=ZLoBLGSX36c"
    creator: "Justin Sung"
