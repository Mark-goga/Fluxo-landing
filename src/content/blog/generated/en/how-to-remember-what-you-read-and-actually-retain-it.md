---
schemaVersion: 1
draftId: "019fabd6-77dc-70a3-98d8-c3a130a3151a"
...
faq:
  - question: "Does reading on an e-reader carry the same disadvantage as reading on a phone?"
    answer: "No. Research consistently shows that e-readers and tablets produce a dramatically smaller comprehension gap compared to phone screens or desktop monitors. If reading on paper is not an option, an e-reader is a meaningfully better alternative to a phone or computer screen."
  - question: "If I tell myself to read more carefully on a screen, does that actually close the gap?"
    answer: "Yes. Studies show that simply instructing screen readers to process more carefully eliminates the performance gap between paper and screen. The screen inferiority effect is a conditioned habit, not a hardware limit. Deliberate attention overrides it."
  - question: "Does spaced repetition work for conceptual material, or only for facts and vocabulary?"
    answer: "Spaced repetition is most commonly associated with vocabulary and isolated facts, but the underlying mechanism, forcing retrieval at intervals timed to memory decay, applies to conceptual material as well. The key is writing flashcards that test understanding and application, not just recognition of a term."
  - question: "Why does it matter that flashcards come from my own notes rather than a shared deck?"
    answer: "Pre-made flashcards lack the context of your reading session. Your own notes carry the conceptual connections and spatial anchors you formed when you first processed the material. Those anchors become retrieval cues. Copying someone else's flashcards skips the comprehension step that makes memory durable."
references: []
author:
  ...
  links:
    linkedin: "https://www.linkedin.com/in/mark-gala/"
    twitter: "https://x.com/markgala"
    github: "https://github.com/mark-gala"
    website: "https://fluxo.today"
sources:
  - id: "019fa886-74b6-73cd-999a-9d6d95f57f04"
    type: "youtube_video"
    title: "The top 1% Learn From Paper. Here’s Why."
